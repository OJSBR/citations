...
**⬇️ Install package:** [OJS 3.5](https://github.com/OJSBR/citations/releases/download/3.5.0.2/citations-3.5.0.2.tar.gz) — or browse all [Releases](../../releases).
...
|-------------|--------|----------------|
| OJS/OPS 3.5.x | [`stable-3_5_0`](../../tree/stable-3_5_0) *(default)* | 3.5.0.2 |
